...
import libraryBotLogo from "../../icons/Telegram_bot_icon.jpg";
...
const projects = [
  ...
  {
    image: libraryBotLogo,
    gradient: "from-blue-500/20 to-cyan-500/10",
    borderColor: "rgba(59,130,246,0.25)",
    glowColor: "rgba(59,130,246,0.15)",
    title: "MyLibraryBot",
    description:
      "A multilingual Telegram bot for managing your personal reading list. Search the Open Library catalogue of 20 million+ books, add them with one tap, track reading progress, rate books, add notes, and view reading statistics. Supports English, Russian, and German with per-user language settings stored in PostgreSQL.",
    techs: [
      "Python",
      "python-telegram-bot",
      "PostgreSQL",
    ...
    github: "https://github.com/AndreiShorop/MyLibraryBot",
    live: "https://t.me/MyLibraryTrackerBot",
    liveLabel: "Try Bot",
    status: "Completed",
      ...
      <div className="max-w-6xl mx-auto">
        ...
        >
          ...
          <p className="text-textMuted mt-3 max-w-xl mx-auto">
            Real-world projects that showcase my skills and problem-solving
            approach.
          </p>
            ...
            >
              ...
              >
                ...
                <div className="absolute top-4 right-4">
                  <span
                    className={`glass-card px-3 py-1 rounded-full text-xs font-mono ${project.statusColor}`}
                  >
                    ● {project.status}
                  </span>
                </div>
